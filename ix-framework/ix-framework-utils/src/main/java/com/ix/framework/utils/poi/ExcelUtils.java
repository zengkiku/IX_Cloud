package com.ix.framework.utils.poi;

import com.ix.framework.utils.*;
import com.ix.framework.utils.annotation.excel.Excel;
import com.ix.framework.utils.annotation.excel.Excel.ColumnType;
import com.ix.framework.utils.annotation.excel.Excel.Type;
import com.ix.framework.utils.annotation.excel.Excels;
import com.ix.framework.utils.exception.IXUtilsException;
import com.ix.framework.utils.file.FileTypeUtils;
import com.ix.framework.utils.file.ImageUtils;
import com.ix.framework.utils.reflect.ReflectUtils;
...
public class ExcelUtils<T> {
	...
	public void exportExcel(HttpServletResponse response, List<T> list, String sheetName, String title) {
		try {
			...
			log.error("数据导出异常:", e);
			throw new IXUtilsException("数据导出异常");
		}
	}
