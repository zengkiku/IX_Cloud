...
public class IXExceptionHandler {

	private final Logger log = LoggerFactory.getLogger(IXExceptionHandler.class);
	 ...
	 * @return JsonResult
	 */
	@ExceptionHandler(IXException.class)
	@ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
	public AjaxResult fastGoException(IXException e) {
