package com.ix.framework.log.aspect;
...
import com.ix.framework.log.enums.BusinessStatus;
...
public class SysLogAspect {
	 ...
	 * 配置切入点
	 */
	@Pointcut("@annotation(com.ix.framework.log.annotation.Log)")
