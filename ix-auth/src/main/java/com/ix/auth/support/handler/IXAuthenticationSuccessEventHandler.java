 ...
 * @Description: 处理登录成功
 */
public class IXAuthenticationSuccessEventHandler implements AuthenticationSuccessHandler {

	private static final Logger log = LoggerFactory.getLogger(IXAuthenticationSuccessEventHandler.class);
