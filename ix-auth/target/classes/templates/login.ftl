...
<div class='container'>
    <div class='row'>
        <div class='col-xs-12'>
            <img src="/static/assets/images/logo.svg" class='img-responsive' alt="logo">
            <p id='welcome'>
                统一登录 - OAuth2
            </p>
            <form action='/token/form' method="POST">
                <input type="hidden" name="client_id" class="form-control" value="ix" placeholder="所属客户端">
